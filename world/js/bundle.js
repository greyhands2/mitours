      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated Sucessfully"));
            }
...
var stripe = Stripe('pk_test_51GxBhaJgcyo0q4CjuhwYlkD75CSX6iacVlZyEbVwHrlXqTiws9qMeZnWKALoKVQdxFuJlyM0FVhasQb7Sybe6gYI00PGTeHsML');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9ueXN0YXJxIiwiYSI6ImNrYTBidGpubjBhaWMzZ3BtZjJhMnNrd2kifQ.Vy5P_ieLDAA8ClBihrQlIg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/tonystarq/cka0ckni304sw1jnnifm538nf',
    scrollZoom: false
  });
...
//DOM ELEMENTS
var mapboxDOM = document.getElementById('map');
var loginFormDOM = document.querySelector('.form--login');
var userDataFormDOM = document.querySelector('.form-user-data');
var userPasswordFormDOM = document.querySelector('.form-user-password');
var logoutButtonDOM = document.querySelector('.nav__el--logout');
var updatePasswordButtonDOM = document.querySelector('.btn--save-password');
var bookBtnDom = document.getElementById('book-tour'); //delegation

if (mapboxDOM) {
  var locations = JSON.parse(mapboxDOM.dataset.locations);
...
if (logoutButtonDOM) {
  logoutButtonDOM.addEventListener('click', function () {
    (0, _login.logout)();
  });
}

if (userDataFormDOM) {
  userDataFormDOM.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (userPasswordFormDOM) {
  userPasswordFormDOM.addEventListener('submit', /*#__PURE__*/function () {
